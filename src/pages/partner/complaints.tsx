...
const RegisterPage = (): JSX.Element => {
  ...
  const partnerHead = ['sn', 'Name', 'Rest. Id', 'Email', 'Rating', 'date_created']
  const usersBody = [
    {
      id: '9023', name: 'KFC Restaurant', bgUrl:'', description: '', createdAt:'10/10/2010',
  ...
  const formattedBody = usersBody.map((td,id) => {
    return (<div key={id} className={`grid grid-cols-[50px_150px_80px_280px_100px_150px] border-t  border-gray-100 hover:bg-gray-100 gap-2 px-2 py-3 transition-all rounded`}>
      ...
      <div className="">
        ...
        <div className="">
          ...
          <div className='mt-8 flex flex-col gap-2'>
            ...
            {/* <Table head={partnerHead} body={formattedBody} columnClass=' grid-cols-[50px_150px_80px_280px_100px_150px] '  /> */}
          </div>
        </div>
      </div>
    </PartnerLayout>
