  ...
  return (
    <div className='w-full h-screen grid grid-cols-[270px_auto]  bg-white'>
      <aside className='bg-r-black hidden lg:block'>
        ...
        <ul>
          <li>
            <Link href={'/admin'} className={` ${activePage == 0 ? 'text-r-black bg-green-200' : 'text-white hover:text-r-black hover:bg-gray-300'} flex items-center gap-2 px-4 py-3 transition-all`}>
          ...
          <li>
            <Link href={'/admin/restaurants'} className={` ${activePage == 1 ? 'text-r-black bg-green-200' : 'text-white hover:text-r-black hover:bg-gray-300'} flex items-center gap-2 px-4 py-3 transition-all`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <li>
            <Link href={'/admin/users'} className={` ${activePage == 2 ? 'text-r-black bg-green-200' : 'text-white hover:text-r-black hover:bg-gray-300'} flex items-center gap-2 px-4 py-3 transition-all`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <li>
            <Link href={'/admin/complaints'} className={` ${activePage == 3 ? 'text-r-black bg-green-200' : 'text-white hover:text-r-black hover:bg-gray-300'} flex items-center gap-2 px-4 py-3 transition-all`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
