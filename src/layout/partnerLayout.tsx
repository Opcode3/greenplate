    ...
    <div className='w-full h-screen grid grid-cols-[270px_auto]  bg-white'>
      <aside className='bg-r-black hidden lg:block'>
        ...
        <ul>
          ...
          <li>
            <Link href={'/admin/tables'} className='flex items-center gap-2 px-4 py-3 text-white hover:text-r-black hover:bg-gray-300 transition-all'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <li>
            <Link href={'/admin/meals'} className='flex items-center gap-2 px-4 py-3 text-white hover:text-r-black hover:bg-gray-300 transition-all'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <li>
            <Link href={'/partner/orders'} className='flex items-center gap-2 px-4 py-3 text-white hover:text-r-black hover:bg-gray-300 transition-all'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
          ...
          <li>
            <Link href={'/partner/complaints'} className='flex items-center gap-2 px-4 py-3 text-white hover:text-r-black hover:bg-gray-300 transition-all'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
PartnerLayout.defaultProps = { title:'Partner'}
